...
export const COURSES: CourseInfo[] = [
  ...
  { id: 5, title: "Planejamento Familiar", description: "Renegociação de dívidas, redução de despesas e orçamento familiar.", points: 45, progress: 0, completed: false, requiredLevel: 3, totalLessons: 6, completedLessons: 0, locked: false, category: "Intermediário", videoUrl: "https://www.youtube.com/watch?v=oLMxWL2w5PY" },
