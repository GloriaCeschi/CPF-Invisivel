...
const Footer = () => (
  <footer className="bg-maskid-dark py-16">
    <div className="container mx-auto px-4 md:px-8">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2">
            {["Sobre nós", "Como funciona", "Parceiros", "Carreiras"].map((l) => (
              <a key={l} href="#" className="text-primary-foreground/50 text-sm hover:text-secondary transition-colors">{l}</a>
            ))}
          </nav>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2 text-primary-foreground/50 text-sm">
              <Mail className="w-4 h-4" /> contato@maskid.com.br
            </div>
            <div className="flex items-center gap-2 text-primary-foreground/50 text-sm">
          ...
          <div className="flex gap-3 mt-4">
            {[Instagram, Twitter, Linkedin].map((Icon, i) => (
              <a key={i} href="#" className="w-9 h-9 rounded-lg bg-primary-foreground/10 flex items-center justify-center text-primary-foreground/50 hover:bg-secondary hover:text-primary-foreground transition-all">
      ...
      <div className="border-t border-primary-foreground/10 pt-6 text-center">
        <p className="text-primary-foreground/30 text-sm">
          © 2025 MaskID. Todos os direitos reservados.
        </p>
      </div>
    </div>
  </footer>
