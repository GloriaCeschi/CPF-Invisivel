...
import { Star, FileText, Brain, CreditCard, Shield, Zap, Globe, TrendingUp } from "lucide-react";
...
const solutions = [
  ...
  { icon: Globe, front: "Parceiros Inclusivos", back: "Conectamos você a bancos e fintechs que aceitam o score alternativo Renda Visível." },
  ...
  return (
    ...
    >
      <div className={`flip-card-inner relative w-full h-full ${flipped ? "[transform:rotateY(180deg)]" : ""}`} style={{ transformStyle: "preserve-3d", transition: "transform 0.6s" }}>
        ...
        {/* Back */}
        <div className="flip-card-back absolute inset-0 bg-primary rounded-2xl p-6 flex items-center justify-center" style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}>
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">
            De <span className="text-primary">invisível</span> a protagonista financeiro
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            A Renda Visível conecta sua vida financeira real ao sistema de crédito. Toque nos cards para entender como.
          </p>
        </motion.div>
