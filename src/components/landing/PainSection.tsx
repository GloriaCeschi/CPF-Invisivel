...
const problems = [
  { icon: UserX, title: "Dependência familiar", description: "Jovens precisam usar o CPF de parentes para qualquer compra parcelada ou contrato." },
  { icon: Wallet, title: "Renda não reconhecida", description: "Freelas, vendas e bicos geram renda real — mas nenhum banco reconhece." },
  { icon: Home, title: "Contas ignoradas", description: "Aluguel, luz e internet pagos em dia não constroem nenhum histórico de crédito." },
  { icon: BarChart3, title: "Análise rígida", description: "O sistema de score atual só funciona para quem já está dentro do sistema financeiro." },
  { icon: Smartphone, title: "Exclusão digital", description: "Sem score, sem crédito, sem conta digital — um ciclo de invisibilidade financeira." },
];
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold text-primary-foreground mb-4">
            O CPF <span className="text-primary">Invisível</span>
          </h2>
